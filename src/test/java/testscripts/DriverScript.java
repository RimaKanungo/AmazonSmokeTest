...
public class DriverScript {
    ...
    public static XlsReader resultReader;
	...
	// locates the Result sheet
	resultReader = new XlsReader(System.getProperty("user.dir") + "/src/test/java/config/controller.xls");
